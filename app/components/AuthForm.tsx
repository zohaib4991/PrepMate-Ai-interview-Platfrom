      ...
      <div className="flex flex-col items-center gap-6 card py-14 px-10">
        ...
        <Form {...form}>
          <form className='w-full space-y-6 mt-4 form' onSubmit={form.handleSubmit(onSubmit)}>
           {!isSignIn && (<FormField control={form.control} name='name' label="Name" placeholder="
           Your Name" />)}
           <FormField control={form.control} name='email' label="Email" placeholder="
           Your email address" type="email" />
           <FormField control={form.control} name='password' label="Password" placeholder="
        ...
        <p className="text-center">
          ...
          <Link className="font-bold text-primary ml-1" href={!isSignIn ? '/sign-in' : '/sign-up'}>
